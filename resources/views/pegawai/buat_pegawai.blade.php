                    ...
                    <div id="wizard_verticle" class="form_wizard wizard_verticle">
                      ...
                      <div id="step-22">
                        ...
                        <br>
                          ...
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3" for="first-name">Tunjangan Fungsioanal <span class="required">*</span></label>
                            <div class="col-md-6 col-sm-6">
                          ...
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3" for="first-name">Tunjangan GTT-PTT <span class="required">*</span></label>
                            <div class="col-md-6 col-sm-6">
