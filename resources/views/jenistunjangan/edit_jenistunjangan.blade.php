...
<div class="container spark-screen">
	    ...
	    <div class="content">
	        <form action="{{ url('update4', $data->id_jenis)}}" method="POST" enctype="multipart/form-data">
            {!! csrf_field() !!}
            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control border-input" name="tunjangan" value="{{$data -> tunjangan}}" placeholder="Jenis Tunjangan" required>
                    </div>
                </div>
            </div>
            <div class="row">
